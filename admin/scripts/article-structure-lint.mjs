...
if (process.argv.includes('--help')) {
  console.log(`Article Structure Linter\n\nEnforces for files under docs/ (except 00-links.md):\n- Title (#)\n- 'What This Is & Why It Matters' section\n- Summary table after that\n- One H2 section per table Item (via in-page anchors)\n- 'Useful Links' section\n- Footer with 'Last Updated', 'Document Version', 'Maintained by'\n\nAllows meta sections (outside the table):\n- Implementation Summary, Results & Impact, Technical Configuration, System Overview\n- Analytics overview/status sections, Schema benefits/strategy/validation, Technical Architecture\n\nUsage:\n  node admin/scripts/article-structure-lint.mjs\n  node admin/scripts/article-structure-lint.mjs --help\n`);
  process.exit(0);
}
